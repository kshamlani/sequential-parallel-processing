 ...
 */
$config['site_title']                 = "Template";       // Site Title, example.com
$config['admin_email']                = "admin@iglulabs.com"; // Admin Email, admin@example.com
$config['default_group']              = 'Tourist';           // Default group, use name
...
/*
 | -------------------------------------------------------------------------
 | Change Password Complete Email Template
 | -------------------------------------------------------------------------
 | Default: hange_password.tpl.php
 */
$config['email_change_password_complete'] = 'change_password.tpl.php';

/*
 | -------------------------------------------------------------------------
 | Reset Password Complete Email Template
 | -------------------------------------------------------------------------
 | Default: hange_password.tpl.php
 */
$config['email_reset_password_complete'] = 'reset_password.tpl.php';
