...
if(ENVIRONMENT == "production"){
    $config['facebook_app_id']              = '835755446572600';
    $config['facebook_app_secret']          = '7d0a7af9b46877755918f75f4c57f7bc';
} else if(ENVIRONMENT == "development"){
    $config['facebook_app_id']              = '1180108642028934';
    $config['facebook_app_secret']          = '72145b1dbdd37da0556d999b4f625784';
...
$config['facebook_login_redirect_url']  = 'social/login_facebook';
