...
|
*/
$config['rest_key_name'] = 'TL-API-KEY';
/*
 * REST JWT AUTH TOKEN KEY Variable
 */
$config['rest_token_key_name'] = 'TL-AUTH-TOKEN';
/*
 * REST LANGUAGE KEY Variable
 */
$config['rest_language_key_name'] = 'TL-LANGUAGE';
/*
 * REST LANGUAGE KEY Variable
 */
$config['rest_time_key_name'] = 'TL-TIME';

/*
 * REST DEVICE KEY Variable
 */
$config['rest_device_key_name'] = 'TL-DEVICE';

/*
 * REST TEST KEY Variable
 */
$config['rest_test_key_name'] = 'TL-TEST';
...
$config['allowed_cors_headers'] = [
  ...
  'Access-Control-Request-Method',
    ...
    $config['rest_token_key_name'],
    $config['rest_language_key_name'],
    $config['rest_time_key_name'],
    $config['rest_device_key_name'],
    $config['rest_test_key_name'],
];
